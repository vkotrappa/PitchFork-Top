/*
  ...
  Allows investors to create custom prompts for the 4 main analysis types:
  - Product-Analysis
  - Market-Analysis
  - Team-Analysis
  - Financial-Analysis
  ...
  1. New Table
    - investor_prompts
      ...
      - report_name (text, constrained to 4 values)
      - custom_prompt (text, nullable - initially NULL)
      - created_at (timestamptz)
      - updated_at (timestamptz)
      - Unique constraint on (user_id, report_name)
  
  2. Security
    - Enable RLS
    - Investors can only view/manage their own prompts
*/
